...
%% TODO: confirm author order, emails, and affiliation details before submission.
\author*[1]{\fnm{Saachi} \sur{Shinde}}\email{saachi.shinde@example.edu}
\author[1]{\fnm{Devika} \sur{Jonjale}}\email{devika.jonjale@example.edu}

\affil*[1]{\orgdiv{Department of Computer Engineering}, \orgname{Institution Name},
\orgaddress{\city{Mumbai}, \country{India}}}
